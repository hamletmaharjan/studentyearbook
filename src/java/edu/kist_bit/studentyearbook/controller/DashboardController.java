 ...
 */
package edu.kist_bit.studentyearbook.controller;
...
public class DashboardController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        EntityManagerFactory emf = (EntityManagerFactory) request.getServletContext().getAttribute("StudentYearbookemf");
